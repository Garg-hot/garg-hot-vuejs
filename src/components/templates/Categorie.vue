...
const addCategorie = async () => {
  ...
  try {
    const response = await categorieService.create(newCategorie.value);
    categories.value.push(response.data.categorie);
...
const updateCategorie = async () => {
  ...
  try {
    await categorieService.update(editCategorie.value.id, editCategorie.value);
